...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/cutmlogo" alt="cra"> </a>
        ...
        <section class="hero bg-image" data-image-src="C:\Users\tadim\Downloads\unnamed.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Centurion University Market Place</h1>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>Choose Your Products</h4> </div>
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span style="color:white;">2. </span>Order Your Products</h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Products Of Centurion University</h2>
                    <p class="lead">Easiest way to order your Products From Centurion University</p>
                </div>
                <div class="row">
						<?php 					
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>We Have Covered the E-vehicles And Rice,Flowers,Books,Furniture,OpticalsPlants,Clothes</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Choose a Product</h3>
                                <p>We"ve got your covered with a variety of  Products</p>
                            </div>
                        </div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>Centurion University Of Technology and management ,Near Tekkali Village Nellimarla Mandal </p>
                                    <h5>Phone: +91 9357974921</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Addition informations</h5>
                                   <p>We have  Number of Good Products who benefit from having partnered with us.</p>
                                </div>
                    </div>
                </div>
